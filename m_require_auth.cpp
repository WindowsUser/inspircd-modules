...
public:
    ...
    virtual ModResult OnCheckReady(LocalUser* user) { //I'm afraid that using the normal xline methods would then result in this line being checked at the wrong time.
